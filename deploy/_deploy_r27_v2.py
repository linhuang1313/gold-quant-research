...
print("[1] Uploading via SFTP...")
sftp = ssh.open_sftp()
sftp.put(r'c:\Users\hlin2\gold-quant-research\experiments\run_round27.py',
...
run('pkill -f run_round 2>/dev/null')
time.sleep(2)
...
if 'run_round27' in out:
    ...
    print(run(f'head -30 {BASE}/results/round27_results/R27_stdout.txt'))
