"""Deploy R83 advanced research to server."""
...
FILES = [
    'experiments/run_r83_advanced_research.py',
...
print("\nLaunching R83...")
c = connect()
c.exec_command("mkdir -p /root/gold-quant-research/results/r83_advanced_research", timeout=15)
time.sleep(1)
c.exec_command(
    "cd /root/gold-quant-research && "
    "nohup python3 -u experiments/run_r83_advanced_research.py "
    "> results/r83_stdout.txt 2>&1 &",
    timeout=10
)
time.sleep(5)
_, out, _ = c.exec_command("ps aux | grep r83 | grep -v grep", timeout=15)
