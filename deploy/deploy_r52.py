"""Deploy R52 lot portfolio optimization to Westd server."""
...
FILES_TO_SYNC = [
    'experiments/run_round52_lot_portfolio.py',
    'backtest/engine.py',
    'backtest/runner.py',
...
time.sleep(3)
c = connect()
ssh(c, 'mkdir -p /root/gold-quant-research/results/round52_results')
c.exec_command(
...
time.sleep(5)
print(ssh(c, 'ps aux | grep round52 | grep python | grep -v grep | head -3') or '!! NOT RUNNING !!')
c.close()
print("\nDeploy complete!")
