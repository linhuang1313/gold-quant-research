...
LOCAL = r"c:\Users\hlin2\gold-quant-research\results\round33_results"
os.makedirs(LOCAL, exist_ok=True)

sftp = ssh.open_sftp()
for f in ['R33_output.txt', 'R33_stdout.txt']:
    try:
        sftp.get(f'{BASE}/results/round33_results/{f}', os.path.join(LOCAL, f))
