"""Deploy R82 Dual PBO validation to server."""
...
FILES = [
    'experiments/run_r82_dual_pbo.py',
...
print("\nLaunching R82...")
c = connect()
c.exec_command("mkdir -p /root/gold-quant-research/results/r82_dual_pbo", timeout=15)
time.sleep(1)
c.exec_command(
    "cd /root/gold-quant-research && "
    "nohup python3 -u experiments/run_r82_dual_pbo.py "
    "> results/r82_stdout.txt 2>&1 &",
    timeout=10
)
time.sleep(5)
_, out, _ = c.exec_command("ps aux | grep r82 | grep -v grep", timeout=15)
