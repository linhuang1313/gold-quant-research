#!/usr/bin/env python3
"""
Round 5C — R5-8 + R5-9 + R5-10 (Server B: 32核/120GB)
======================================================
Server A 的 R5-8 因 BrokenPipeError 失败，全部迁移到 Server B
MAX_WORKERS=16
"""
...
def main():
    ...
    with open(master_log, 'a') as mf:
        mf.write(f"\n--- Round 5C (Server B: all phases) Started: {datetime.now()} ---\n")
        ...
        mf.write(f"\nRound 5C Finished: {datetime.now()}\n")
