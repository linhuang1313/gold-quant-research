#!/usr/bin/env python3
"""
R63-R65 Anti-Overfitting Test Suite Orchestrator
=================================================
Runs three anti-overfitting tests sequentially:
  R63: Walk-Forward Nested Validation (~10min)
  R64: Monte Carlo Robustness Testing (~15min)
  R65: Spread & Slippage Stress Test (~10min)
"""
import sys, os, io, time, subprocess, json
...
SCRIPTS = [
    ('R63', ROOT / 'run_r63_walk_forward.py'),
    ('R64', ROOT / 'run_r64_monte_carlo.py'),
    ('R65', ROOT / 'run_r65_spread_stress.py'),
]

def main():
    total_start = time.time()
    print(f"\n{'#'*70}")
    print(f"  Anti-Overfitting Test Suite (R63-R65)")
